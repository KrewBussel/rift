...
export async function PATCH(req: Request) {
  ...
  const parsed = await parseBody(req, ComplianceUpdateSchema);
  ...
  await recordAudit({
    ...
    action: "firm.compliance.updated",
  ...
  return NextResponse.json({
    complianceContactEmail: updated.complianceContactEmail,
