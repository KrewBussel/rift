-- Add aiMonthlyLimit to FirmSettings
ALTER TABLE "FirmSettings" ADD COLUMN "aiMonthlyLimit" INTEGER NOT NULL DEFAULT 500;
...
ALTER TABLE "AiUsage" ADD CONSTRAINT "AiUsage_firmId_fkey"
